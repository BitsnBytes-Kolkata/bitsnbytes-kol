...
const faqs: FAQItem[] = [
  ...
  {
    question: "Can I show existing projects at Bits & Bytes Kolkata?",
    answer:
      "No, you cannot show existing projects at our hackathons. All projects must be created during the event.",
  },
  {
    question: "Can parents attend Bits & Bytes Kolkata?",
    answer:
