                    ...
                    >
                        <div className="relative m-auto h-full w-full flex flex-col items-center justify-center p-8 md:p-12">
                            <div className="relative flex h-24 w-56 items-center">
                                <svg className="text-(--brand-red) absolute inset-0 size-full opacity-50" viewBox="0 0 254 104" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <div className="w-full">
                            <svg className="w-full h-32" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clipPath="url(#clip0_0_106)">
                                    <circle className="text-(--brand-red) opacity-20" cx="193" cy="40" r="30" fill="currentColor" />
                                    <CodeXml className="text-(--brand-red)" x="178" y="25" width="30" height="30" />
                                </g>
                                <path
                                    fillRule="evenodd"
                                    clipRule="evenodd"
                                ...
                                <defs>
                                    <linearGradient id="paint0_linear_0_106" x1="3" y1="60" x2="3" y2="123" gradientUnits="userSpaceOnUse">
                                        <stop className="text-(--brand-red)/20" stopColor="currentColor" />
