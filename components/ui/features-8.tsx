        ...
        <div className="mx-auto max-w-6xl">
            <div className="relative">
                <div className="relative z-10 grid grid-cols-6 gap-3">
                    ...
                    <Card className="relative col-span-full flex overflow-hidden lg:col-span-2 glass-panel border-white/10 bg-white/5 backdrop-blur-xl">
                        <CardContent className="relative m-auto size-fit pt-8 pb-8">
                            <div className="relative flex h-24 w-56 items-center">
                                <svg className="text-[var(--brand-pink)] absolute inset-0 size-full opacity-50" viewBox="0 0 254 104" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                ...
                                <span className="mx-auto block w-fit text-5xl font-bold text-white">200+</span>
                            </div>
                            <h2 className="mt-8 text-center text-2xl font-bold text-white uppercase tracking-tight">Across India</h2>
                        </CardContent>
                    </Card>

                    {/* Card 2: Workshops */}
                    <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2 glass-panel border-white/10 bg-white/5 backdrop-blur-xl">
                        <CardContent className="pt-8 pb-8">
                            <div className="relative mx-auto flex aspect-square size-32 rounded-full border border-white/10 before:absolute before:-inset-2 before:rounded-full before:border before:border-white/5">
                                <Lightbulb className="m-auto h-12 w-12 text-[var(--brand-pink)]" />
                            </div>
                            <div className="relative z-10 mt-8 space-y-2 text-center">
                                <h2 className="text-xl font-bold text-white transition">Workshops</h2>
                                <p className="text-sm text-zinc-400">Mastering dev tools and AI, one weekend at a time.</p>
                            </div>
                        </CardContent>
                    </Card>
                            ...
                            <div className="lg:px-6">
                                <svg className="w-full h-32" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_0_106)">
                                        <circle className="text-[var(--brand-pink)] opacity-20" cx="193" cy="40" r="30" fill="currentColor" />
                                        <CodeXml className="text-[var(--brand-pink)]" x="178" y="25" width="30" height="30" />
                                    </g>
                                    <path
                                        fillRule="evenodd"
                                        clipRule="evenodd"
                                    ...
                                    <defs>
                                        <linearGradient id="paint0_linear_0_106" x1="3" y1="60" x2="3" y2="123" gradientUnits="userSpaceOnUse">
                                            <stop className="text-[var(--brand-pink)]/20" stopColor="currentColor" />
                                            <stop className="text-transparent" offset="1" stopColor="currentColor" stopOpacity="0" />
                                        </linearGradient>
                                        <clipPath id="clip0_0_106">
                                            <rect width="358" height="60" fill="white" transform="translate(14 14)" />
                                        </clipPath>
                                    </defs>
                                </svg>
                            </div>
                            <div className="relative z-10 mt-8 space-y-2 text-center">
                                <h2 className="text-xl font-bold text-white transition">15+ Projects</h2>
                                <p className="text-sm text-zinc-400">From apps to AI, shipping to production.</p>
                            </div>
                        </CardContent>
                    </Card>
                        ...
                        <CardContent className="grid pt-8 pb-8 sm:grid-cols-2">
                            <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                <div className="relative flex aspect-square size-12 rounded-full border border-white/10 before:absolute before:-inset-2 before:rounded-full before:border before:border-white/5">
                                    <Rocket className="m-auto size-6 text-[var(--brand-pink)]" />
                                </div>
                                <div className="space-y-4">
                                    <h2 className="text-2xl font-bold text-white transition">Innovation</h2>
                                    <p className="text-zinc-400">Building the labs of tomorrow with AI, distributed systems, and creative code.</p>
                                </div>
                            </div>
                            <div className="rounded-2xl relative -mb-6 -mr-6 mt-6 h-fit border-l border-t border-white/10 p-6 sm:ml-6">
                                <div className="absolute left-3 top-2 flex gap-1">
                                    <span className="block size-2 rounded-full border border-white/10 bg-white/5"></span>
                                    <span className="block size-2 rounded-full border border-white/10 bg-white/5"></span>
                                    <span className="block size-2 rounded-full border border-white/10 bg-white/5"></span>
                                </div>
