                        ...
                        <div className="w-full">
                            <svg className="w-full h-32" viewBox="0 0 386 123" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clipPath="url(#clip0_0_106)">
                                    <circle className="text-(--brand-pink) opacity-20" cx="193" cy="40" r="30" fill="currentColor" />
                                    <CodeXml className="text-(--brand-pink)" x="178" y="25" width="30" height="30" />
                                </g>
                                <path
                                    fillRule="evenodd"
                                    clipRule="evenodd"
                                ...
                                <defs>
                                    <linearGradient id="paint0_linear_0_106" x1="3" y1="60" x2="3" y2="123" gradientUnits="userSpaceOnUse">
                                        <stop className="text-(--brand-pink)/20" stopColor="currentColor" />
