...
Our palette is designed to feel **youthful, bold, and creative**, while still being **reliable and professional**.

| Color Name      | Hex Code   | RGB                | Primary Usage                                  |
|-----------------|-----------|--------------------|------------------------------------------------|
| **Deep Purple** | `#3E1E68` | `rgb(62, 30, 104)` | Primary brand color, headings, main CTAs       |
| **Rich Plum**   | `#5D2F77` | `rgb(93, 47, 119)` | Accents, supporting UI elements                |
| **Vibrant Pink**| `#E45A92` | `rgb(228, 90, 146)`| Interactive elements, highlights, energy shots |
| **Soft Coral**  | `#FFACAC` | `rgb(255, 172, 172)`| Backgrounds, soft gradients, warm details     |

**Color philosophy:**  
We combine the depth and trust of purple with the energy of pink to create a brand that feels **ambitious, experimental, and community‑driven**.
...
### 4.1 Core Principles
1. **Teen‑Led Innovation** – Young builders lead real projects and own decisions.  
2. **Collaboration First** – We default to pairing, sharing context, and helping each other.  
3. **Learning by Doing** – We ship, get feedback, and iterate instead of waiting for “perfect”.  
4. **Community Impact** – We prefer projects that help other learners and local communities.
...
2. **Planning** – Scope the MVP, set milestones, define roles.  
3. **Development** – Work in short sprints with regular check‑ins.  
...
### 5.1 For New Members
- Join the **Discord** community and introduce yourself.  
- Attend weekly **workshops** and **study sessions**.  
- Join project channels that match your interests (web, mobile, events, content, etc.).  
- Contribute to open‑source repos and ask for beginner‑friendly issues.

### 5.2 For Contributors & Mentors
- Check our GitHub org for **open issues** and project boards.  
- Read contribution guidelines and follow the existing code style.  
- Join code review sessions to help others level up.  
- Propose and run your own workshops or mini‑projects.
...
### Internal
- **Team Meetings:** Weekly sync‑up every Monday  
- **Daily Standups:** Quick async updates via Discord  
